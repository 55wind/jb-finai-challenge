...
S = [
    ...
    ('기능 ③', '준법 오토파일럿',
     ...
     '심의→고쳐쓰기→재심의 반복으로 자율 개선 (미수렴 시 사람 에스컬레이션)'),
    ('수정 후', '안전 버전 재시뮬레이션',
     '준법 통과 등급에서 소비자 오해가 해소되는지 다시 확인합니다',
     fit_canvas(f'{R}/s_safe.png', (430, 95, 1280, 1175)),
     '수정 후 — 준법 통과(94) · 페르소나 3종 오해 "위험→주의" 완화 · 룰 위반 0'),
    ('기능 ④', '준법관리자 검토·승인',
     'AI 1차심의를 근거로 사람이 승인, 모든 이력은 감사로그로 남습니다',
     fit_canvas(f'{R}/s_approve.png'),
     '원문 직접 검토 확인 후 승인 — 최종 판단·책임은 준법감시인'),
    ('기능 ⑤', '마케팅 배포 Last-Mile',
     '승인된 콘텐츠만 채널로 자동 발송됩니다',
     fit_canvas(f'{R}/s_distribute.png'),
     '승인본을 채널로 자동 발송 · AI 개선→사람 승인→시스템 배포 분리 기록'),
    ('기능 ⑥', '다국어 생성·재심의',
     '외국어 버전을 만들고 직역 오역까지 다시 심의합니다',
     fit_canvas(f'{R}/s_multilingual.png'),
